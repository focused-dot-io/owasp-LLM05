...
See [DEMO_PROMPTS.md](DEMO_PROMPTS.md) for ready-to-use prompts that demonstrate the XSS vulnerability. The prompts show how attackers can bypass LLM safety filters using educational framing and indirect injection techniques.
